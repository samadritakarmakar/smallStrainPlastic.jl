...
The partial of plastic strain flow rule function with respect to hardening, ∂𝚯/∂𝐪:- ∂𝚯_∂𝐪!

The function in the flow rule for the internal variable 𝛂̇ = λ̇  𝐡(𝛔, 𝐪):- 𝐡!
